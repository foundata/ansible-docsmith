...
class TestEndToEnd:
    ...
    def test_generate_command_with_actual_files(self, sample_role_with_specs_and_defaults):
        ...
        assert "Primary domain name" in defaults_content or "Email address for ACME" in defaults_content
